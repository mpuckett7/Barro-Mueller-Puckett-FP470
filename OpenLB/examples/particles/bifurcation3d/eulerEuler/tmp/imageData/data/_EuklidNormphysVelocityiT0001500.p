...
set output './tmp/imageData/_EuklidNorm(physVelocity)iT0001500.jpeg'
} else {set terminal png size 1000,1690font ",25"
set output './tmp/imageData/_EuklidNorm(physVelocity)iT0001500.png'
}
set pm3d map
unset key
set xtics out
...
splot './tmp/imageData/data/_EuklidNorm(physVelocity)iT0001500.matrix' u ($1*0.00017541+-0.0307839):($2*0.00017541+-0.0252273):3 matrix with pm3d
