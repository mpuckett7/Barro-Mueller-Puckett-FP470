...
set output './tmp/imageData/_qualityiT0000300.jpeg'
} else {set terminal png size 5825,1000font ",25"
set output './tmp/imageData/_qualityiT0000300.png'
}
set pm3d map
unset key
set xtics out
...
splot './tmp/imageData/data/_qualityiT0000300.matrix' u ($1*0.0042+-0.0075):($2*0.0042+0.0025):3 matrix with pm3d
