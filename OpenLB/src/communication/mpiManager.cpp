...
namespace olb
{
  ...
  namespace singleton
  {
    ...
    template <>
    void MpiManager::iSend<bool>(bool *buf, int count, int dest, MPI_Request *request, int tag, MPI_Comm comm)
    {
      if (ok)
      {
    ...
    template <>
    void MpiManager::iSend<char>(char *buf, int count, int dest, MPI_Request *request, int tag, MPI_Comm comm)
    {
      if (ok)
      {
    ...
    template <>
    void MpiManager::iSend<int>(int *buf, int count, int dest, MPI_Request *request, int tag, MPI_Comm comm)
    {
      if (ok)
      {
    ...
    template <>
    void MpiManager::iSend<float>(float *buf, int count, int dest, MPI_Request *request, int tag, MPI_Comm comm)
    {
      if (ok)
      {
    ...
    template <>
    void MpiManager::iSend<double>(double *buf, int count, int dest, MPI_Request *request, int tag, MPI_Comm comm)
    {
      if (ok)
      {
    ...
    template <>
    void MpiManager::iSend<long double>(long double *buf, int count, int dest, MPI_Request *request, int tag, MPI_Comm comm)
    {
      if (ok)
      {
    ...
    template <>
    void MpiManager::ibSend<bool>(bool *buf, int count, int dest, MPI_Request *request, int tag, MPI_Comm comm)
    {
      if (ok)
      {
    ...
    template <>
    void MpiManager::ibSend<char>(char *buf, int count, int dest, MPI_Request *request, int tag, MPI_Comm comm)
    {
      if (ok)
      {
    ...
    template <>
    void MpiManager::ibSend<int>(int *buf, int count, int dest, MPI_Request *request, int tag, MPI_Comm comm)
    {
      if (ok)
      {
    ...
    template <>
    void MpiManager::ibSend<float>(float *buf, int count, int dest, MPI_Request *request, int tag, MPI_Comm comm)
    {
      if (ok)
      {
    ...
    template <>
    void MpiManager::ibSend<double>(double *buf, int count, int dest, MPI_Request *request, int tag, MPI_Comm comm)
    {
      if (ok)
      {
    ...
    template <>
    void MpiManager::sendRecv<bool>(bool *sendBuf, bool *recvBuf, int count, int dest, int source, int tag, MPI_Comm comm)
    {
      if (!ok)
      {
        return;
    ...
    template <>
    void MpiManager::sendRecv<char>(char *sendBuf, char *recvBuf, int count, int dest, int source, int tag, MPI_Comm comm)
    {
      if (!ok)
      {
        return;
    ...
    template <>
    void MpiManager::sendRecv<int>(int *sendBuf, int *recvBuf, int count, int dest, int source, int tag, MPI_Comm comm)
    {
      if (!ok)
      {
        return;
    ...
    template <>
    void MpiManager::sendRecv<float>(float *sendBuf, float *recvBuf, int count, int dest, int source, int tag, MPI_Comm comm)
    {
      if (!ok)
      {
        return;
    ...
    template <>
    void MpiManager::sendRecv<long>(long *sendBuf, long *recvBuf, int count, int dest, int source, int tag, MPI_Comm comm)
    {
      if (!ok)
      {
        return;
    ...
    template <>
    void MpiManager::sendRecv<double>(double *sendBuf, double *recvBuf, int count, int dest, int source, int tag, MPI_Comm comm)
    {
      if (!ok)
      {
        return;
    ...
    template <>
    void MpiManager::sendRecv<long double>(long double *sendBuf, long double *recvBuf, int count, int dest, int source, int tag, MPI_Comm comm)
    {
      if (!ok)
      {
        return;
    ...
    MpiNonBlockingHelper::MpiNonBlockingHelper() : _size(0)
    {
    }
